...
| `uv run ruff check` · `mypy` · `pytest`         | clean · clean · **146 passed, 8 skipped** (P8: 137) — +9: labels weight/decay/personal, store+rebuild, latest wins, interleave, bandit untouched, /labels auth, beliefs/rung-2 |
...
## 4. Adversarial pass (fresh-context subagent, 2026-08-29)

_(findings + fixes pasted at the close)_
