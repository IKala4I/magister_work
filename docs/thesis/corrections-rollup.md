...
**Progress:** step 1 (§3, the four statements) and step 2 (Розділ 6) are done —
`docs/thesis/text/rozdil-6.md`. D5 is delivered as `text/dodatok-g.md`. Next is step 3, Розділ 5,
whose plan is §9.1.
