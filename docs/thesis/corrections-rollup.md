...
> прогалина, яку ніхто не помітив, а наслідок того, що властивості, які роблять рекомендування
> часових інтервалів складним, є тими самими властивостями, які роблять польове оцінювання дорогим.
> Винагорода є відкладеним поведінковим результатом, тож одиницею спостереження стає тиждень, а не
> клік. Інтервал вичерпний, а призначення комбінаторно зв'язані, тож інтервенцією є цілий розклад, і
> рандомізувати окремий елемент дешево не вдається – звідси потреба вкласти мікрорандомізоване
> випробування всередину реверсивного дизайну (підрозділ 5.2).
>
...
> застосунок каже про це прямо. Прев'ю-чип показує назву, тривалість і дедлайн, а решті полів FR-10
