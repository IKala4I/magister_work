...
> +10,0 і +18,6 для виразно вечірніх), проміжні лишаються біля нуля (+0,35 і −0,09), а ранкові
> втрачають 0,9–2,3 в. п. (DM −1,82 і −0,85; MM −1,66 і −2,26).
>
...
>
> _Навчений рушій не обслуговував телефон до другого ранку._ Першого вечора всі тридцять запитів плану з
