...
61. **§3 (проєктування) — принципи взаємодії та рядок стеку «Анімації та жести» (File 02
    ...
    **Amended 2026-09-09 (ADR-0022, spec-conflicts L42 closed):** the principle is now realised
    ...
    перехід не реєструється тим самим шляхом. Заміри: Pixel 7a 11 / 10 / 14 / 12 / 19 кадрів при
    60 fps, 0 порожніх карток, 60 fps без регресії на 13 блоках; iPhone 12 без пропущених
