...
8. `Хронотипні приори не знижують ризик першого тижня вимірно: їхній внесок у симуляції
становить ±0,4 в. п.`
9. `Не всі кольорові пари відповідають WCAG 2.2 AA як текст`
   → Do not restore the older, friendlier "усі кольорові пари задовольняють WCAG 2.2 AA".
10. `Опитувальник не перекладено.`
11. `Послідовнісна модель SASRec-lite, он-девайс ONNX-ранжувальник і текстові вкладення MiniLM
віднесені до перспектив.`
    → naming an unbuilt component in order to place it among the perspectives is deliberate.
    Do not delete the sentence.
12. `жодного подання до магазинів не виконано`
13. `Мережева складова розкладу (0,90 с) є власним виміром цієї роботи на еталонному пристрої,
