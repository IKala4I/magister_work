...
_P10 built (notifications, privacy, a11y, performance; ADR-0014; PR #19). P11 (Training pipeline + OPE + study mode) opens next — read docs/HANDOFF.md for the exact spec sections it needs and the ⛔ migration push._
