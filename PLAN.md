...
_P8 complete (sync live on the hosted project; Google Calendar half awaits the owner's Google Cloud gate). P9 (Trust surfaces) opens next — read docs/HANDOFF.md for the exact spec sections it needs._
