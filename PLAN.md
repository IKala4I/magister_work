...
_Status (2026-08-30):_ built per ADR-0014 — local notifications planned by a pure function over a
...
- `delete-account` (self/operator/retention) with the cascade proven by pgTAP on the linked
  ...
  round trips — revisit). Live export/erasure smoke pending the ⛔ migration push.
