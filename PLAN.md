...
_P11 built (training pipeline + OPE + study mode; ADR-0015; PR #21). P12 (Release prep) opens next — read docs/HANDOFF.md for the exact reading list, the ⛔ migration push + VM steps, and the pre-P12 hardware pass._
