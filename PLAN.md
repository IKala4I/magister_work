...
_P9 code-complete (trust surfaces; ADR-0013). P10 (Notifications, privacy, a11y, performance) opens next — read docs/HANDOFF.md for the exact spec sections it needs and the ⛔ migration push._
