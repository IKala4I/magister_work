...
_P7 + P7.1 complete (service live on the Oracle VM, measurements recorded). P8 (Sync) opens next — read docs/HANDOFF.md for the exact spec sections it needs._
