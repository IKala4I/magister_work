...
_P8 complete (sync live on the hosted project; Google Calendar verified live against Google on 2026-08-29). P9 (Trust surfaces) opens next — read docs/HANDOFF.md for the exact spec sections it needs._
