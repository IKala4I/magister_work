...
_P0–P12 built. P12 (release prep) closed the build plan: what remains before enrollment is owner-run — the hardware verification pass (device-checklist), DPIA signature + consent contact block, developer accounts + store economics decision, the recsys_service DSN rotation, the Google consent screen to production, and the OSF-freeze bundle. docs/HANDOFF.md carries the ordered list._
